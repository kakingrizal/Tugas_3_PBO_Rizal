...
public class Rizal21F extends Mahasiswa {
    Rizal21F(String nim, String nama, int nilai){
    ...
    public static void main(String[] args) {
        ...
        for(int i=0;i<=3;i++){
            ...
            mhs.add(new Rizal21F(nim,nama,nilai));
            System.out.println("");
        }
        ...
        mhs.get(3).getNilai()>=0 && mhs.get(3).getNilai()<=100
            ...
            System.out.println(mhs.get(0).getNilai()+"+"+mhs.get(1).getNilai()+"+"+mhs.get(2).getNilai()+"+"+mhs.get(3).getNilai()+" / "+mhs.size()+" = "+Rata2);    
        }
        else{
